...
def delete_post(post_id):
	...
	db.session.commit()
	flash('Your post is deleated','success')
...
Ignore if you wish to revert the changes.
'''
	mail.send(msg)
...
def reset_request():
	...
	if form.validate_on_submit():
		...
		flash('Password reset instructions has been sent to your mail','info')
		return redirect(url_for('login'))
...
def reset_token(token):
	...
	if form.validate_on_submit():
		...
		db.session.commit()
		flash('Password Successfully Updated. You can Login with new credentials ','success')
		return redirect(url_for('login'))
